...
#class DoubanSpider(Spider):
	...
	rules=(
		Rule(LinkExtractor(allow=(r'http://movie\.douban\.com/top250\?start=\d+&filter=')),callback='parse_item',follow=True),
	)
  #rules = (Rule(LinkExtractor(allow=(r'\?start=\d+&filter=')),callback='parse_item'),)
